...
def fasta2inputs(
    ...
    for i, (ch, fas) in enumerate(combined):
        ...
        aatype = torch.LongTensor(
            [rc.restypes_with_x.index(aa) if (aa != '-' and aa in rc.restypes_with_x) else 20 for aa in fas]
        )
...
def get_args(input_file='../../../data/dig_demo_data/1ake.fasta', 
    output_dir='./results') -> typing.Tuple[
    ...
    parser.add_argument(
        ...
        default='../../../data/dig_demo_data/1ake.fasta',
        help=
        """
    ...
    parser.add_argument(
        '--weights_file',
        default='./pretrained_model/model.pt',
        type=str,
